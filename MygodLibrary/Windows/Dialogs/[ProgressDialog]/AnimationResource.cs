...
namespace Mygod.Windows.Dialogs
{
    ...
    public sealed class AnimationResource
    {
        ...
        /// <returns>
        ///     An instance of the <see cref="AnimationResource" /> class representing the specified animation.
        /// </returns>
        ...
        internal SafeModuleHandle LoadLibrary()
        {
            ...
            if (handle.IsInvalid)
            {
                ...
                if (error == NativeMethods.ErrorFileNotFound)
                    throw new FileNotFoundException(string.Format(CultureInfo.CurrentCulture, "The file \"{0}\" could not be found.", ResourceFile));
