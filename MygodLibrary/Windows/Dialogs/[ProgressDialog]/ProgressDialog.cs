...
namespace Mygod.Windows.Dialogs
{
    ...
    public partial class ProgressDialog : Component
    {
        ...
        ///     The <see cref="IContainer" /> to which the component should be added.
        /// </param>
        ...
        ///     </para>
        /// </remarks>
        [Localizable(true), Category("Appearance"), Description("Additional details about the operation being carried out."),
         DefaultValue("")]
        ...
        ///     </para>
        /// </remarks>
        [Localizable(true), Category("Appearance"), Description("The text that will be shown after the Cancel button is pressed."),
         DefaultValue("")]
        public string CancellationText { get { return _cancellationText ?? string.Empty; } set { _cancellationText = value; } }
        ...
        /// </summary>
        /// <value>
        ///     One of the values of <see cref="Mygod.Windows.Dialogs.ProgressBarStyle" />.
        ///     The default value is <see cref="Mygod.Windows.Dialogs.ProgressBarStyle.ProgressBar" />.
        /// </value>
        /// <remarks>
        ///     <note>
        ...
        ///         <see
        ///             cref="Mygod.Windows.Dialogs.ProgressBarStyle.MarqueeProgressBar" />
        ///         .
        ///     </note>
        ///     <para>
        ///         When this property is set to <see cref="Mygod.Windows.Dialogs.ProgressBarStyle.ProgressBar" />, use the
        ///         <see
        ///             cref="ReportProgress(int)" />
        ///         method to set
        ...
        /// </value>
        [Browsable(false)]
        public bool IsBusy { get { return _backgroundWorker.IsBusy; } }
        ...
        ///         <see
        ///             cref="Mygod.Windows.Dialogs.ProgressBarStyle.MarqueeProgressBar" />
        ///         or <see cref="Mygod.Windows.Dialogs.ProgressBarStyle.None" />.
        ///     </para>
        /// </remarks>
        ...
        ///     A state object that will be passed to the <see cref="ProgressChanged" /> event handler.
        /// </param>
        /// <remarks>
        ///     Call this method from the <see cref="DoWork" /> event handler if you want to report progress.
        /// </remarks>
        ...
        /// </summary>
        /// <param name="e">
        ///     The <see cref="DoWorkEventArgs" /> containing data for the event.
        /// </param>
        ...
        /// </summary>
        /// <param name="e">
        ///     The <see cref="ProgressChangedEventArgs" /> containing data for the event.
        /// </param>
            ...
            if (Animation != null)
                ...
                catch (Win32Exception ex)
                {
                    throw new InvalidOperationException(
                        string.Format(CultureInfo.CurrentCulture, "Unable to load the progress dialog animation: {0}", ex.Message), ex);
                }
