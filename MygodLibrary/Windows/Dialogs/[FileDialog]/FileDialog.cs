...
using OpenFileDialog = Mygod.Windows.Dialogs.OpenFileDialog;
...
namespace Mygod.Windows.Dialogs
{
    ...
    ///     </para>
    ///     <para>
    ///         This class precisely duplicates the public interface of <see cref="Microsoft.Win32.FileDialog" /> so you can just replace
    ///         any instances of <see cref="Microsoft.Win32.FileDialog" /> with the <see cref="FileDialog" /> without any further changes
    ///         to your code.
    ///     </para>
    /// </remarks>
    ...
    public abstract class FileDialog
    {
        ...
        /// </remarks>
        [Browsable(false)]
        public static bool IsVistaFileDialogSupported { get { return NativeMethods.IsWindowsVistaOrLater; } }
        ...
        [SuppressMessage("Microsoft.Performance", "CA1819:PropertiesShouldNotReturnArrays"),
         ...
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)] // suppressed because it matches FileDialog
        ...
        ///     .
        /// </value>
        [DefaultValue(false), Description("A value indicating whether the dialog box restores the current directory before closing."),
         Category("Behavior")]
        ...
        /// </summary>
        /// <returns>
        ///     If the user clicks the OK button of the dialog that is displayed (e.g. <see cref="OpenFileDialog" />,
        ///     <see
        ///         cref="SaveFileDialog" />
        ...
        /// </summary>
        /// <param name="e">
        ///     A <see cref="System.ComponentModel.CancelEventArgs" /> that contains the event data.
        /// </param>
        ...
        {
            uint cookie;
            dialog.Advise(new FileDialogEvents(this), out cookie);
