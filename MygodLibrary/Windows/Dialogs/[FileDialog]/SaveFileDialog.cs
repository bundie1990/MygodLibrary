    ...
    public sealed class SaveFileDialog : FileDialog
    {
        ...
        protected override void OnFileOk(CancelEventArgs e)
        {
            ...
            if (DownlevelDialog == null)
            {
                ...
                {
                    PromptUser(ComDlgResources.FormatString(ComDlgResources.ComDlgResourceId.FileNotFound, Path.GetFileName(FileName)),
                ...
                if (CreatePrompt && !File.Exists(FileName))
                    if (
                        !PromptUser(
                                    ComDlgResources.FormatString(ComDlgResources.ComDlgResourceId.CreatePrompt, Path.GetFileName(FileName)),
